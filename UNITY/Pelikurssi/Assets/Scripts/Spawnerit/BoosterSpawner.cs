...
public class BoosterSpawner : MonoBehaviour
{
	...
	void OnTriggerExit(Collider other)
	{
		if (other.gameObject.CompareTag("Player"))          // Sienen piilottaminen kun siihen osuu.
		{
			...
			StartCoroutine(SpawnaaBooster());                //Aloitetaan rutiini joka on asetettu alempana.
	...
	IEnumerator SpawnaaBooster()                //Rutiini: Kun pelaaja osuu sieneen randomSpawner funktio pyörii läpi
