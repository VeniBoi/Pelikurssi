...
namespace AltSystems.AltTrees
{
    ...
    public class AltTree : MonoBehaviour
    {
        ...
        [HideInInspector]
        public Texture2D normalMapBillboard;
        [HideInInspector]
        ...
        [HideInInspector]
        public float densityObjects = 1f;

        [HideInInspector]
        public bool gpuInstancing = false;

        [HideInInspector]
        public Color barkSpecularPBR = new Color(0.058f, 0.058f, 0.058f, 1f);
        [HideInInspector]
        public float barkSmoothnessPBR = 0.016f;

        [HideInInspector]
        public Color leavesSpecularPBR = new Color(0.094f, 0.094f, 0.094f, 1f);
        [HideInInspector]
        public float leavesSmoothnessPBR = 0.031f;
        ...
        public float billboardsMipMapBias = -2f;
        public float billboardsNormalMapMipMapBias = -1.4f;
        ...
        #if UNITY_EDITOR
            #if !(UNITY_5_2 || UNITY_5_3 || UNITY_5_4)
                public TextureImporterType textureImporterType_Normals = TextureImporterType.NormalMap;
            #else
        ...
        public bool mipmapEnabled_Normals = true;
        public int anisoLevel_Normals = 8;
        ...
        public void getTextureBillboard(bool isTemp, string textProgressBar = "")
        {
            ...
            Color32 colZero = new Color32(0, 0, 0, 0);

            camTemp.backgroundColor = colZero;
            ...
            float reflectionIntensityStar = RenderSettings.reflectionIntensity;


            RenderSettings.reflectionIntensity = 0f;
            RenderSettings.ambientMode = ambientMode;
            RenderSettings.ambientLight = ambientLight * ambientIntensity;
            ...
            goTreeTempp.transform.localScale = Vector3.one;
            ...
            #if UNITY_EDITOR
            {
                EditorUtility.DisplayProgressBar(textProgressBar == "" ? "Generating Texture Billboard... " : textProgressBar, "Generating Texture Billboard... ", 0.10f);
            }
            #endif
            ...
            for (int k = 0; k < 9; k++)
            {
                ...
                DestroyImmediate(virtualPhoto3);

                for (int i = 0; i < sizeTextureBillboard; i++)
                {
                    for (int j = 0; j < sizeTextureBillboard; j++)
                    {
                        if (!AltUtilities.color32isZero(ref cols3[j * sizeTextureBillboard + i]))
                        {
                            if (maxX > i)
                                maxX = i;
                ...
                for (int i = 0; i < sizeTextureBillboard; i++)
                {
                    for (int j = 0; j < sizeTextureBillboard; j++)
                    {
                        if (!AltUtilities.color32isZero(ref cols3[i * sizeTextureBillboard + j]))
                        {
                            if (maxY > i)
                            {
                                maxY = i;
            ...
            #if UNITY_EDITOR
            {
                EditorUtility.DisplayProgressBar(textProgressBar == "" ? "Generating Texture Billboard... " : textProgressBar, "Generating Texture Billboard... ", 0.2f);
            }
            #endif
            ...
            #if UNITY_EDITOR
            {
                EditorUtility.DisplayProgressBar(textProgressBar == "" ? "Generating Texture Billboard... " : textProgressBar, "Generating Texture Billboard... ", 0.3f);
            }
            #endif
            ...
            for (int i = 0; i < sizeTextureBillboard; i++)
            {
                ...
                for (int j = 0; j < sizeTextureBillboard; j++)
                {
                    if (isCol)
                    {
                        if (AltUtilities.color32isZero(ref cols[i * sizeTextureBillboard + j]))
            ...
            #if UNITY_EDITOR
            {
                EditorUtility.DisplayProgressBar(textProgressBar == "" ? "Generating Texture Billboard... " : textProgressBar, "Generating Texture Billboard... ", 0.4f);
            }
            #endif
            ...
            for (int i = 0; i < sizeTextureBillboard; i++)
            {
                ...
                for (int j = 0; j < sizeTextureBillboard; j++)
                {
                    if (isCol)
                    {
                        if (AltUtilities.color32isZero(ref cols[j * sizeTextureBillboard + i]))
            ...
            #if UNITY_EDITOR
            {
                EditorUtility.DisplayProgressBar(textProgressBar == "" ? "Generating Texture Billboard... " : textProgressBar, "Generating Texture Billboard... ", 0.6f);
            }
            #endif
            ...
            {
                for (int g = 0; g < barkMaterials.Length; g++)
                {
                    barkMaterials[g].SetColor("_SpecularColor", barkSpecularPBR);
                    barkMaterials[g].SetFloat("_Glossiness", barkSmoothnessPBR);
                }
            }
            if (leavesMaterials != null)
            {
                for (int g = 0; g < leavesMaterials.Length; g++)
                {
                    leavesMaterials[g].SetColor("_SpecularColor", leavesSpecularPBR);
                    leavesMaterials[g].SetFloat("_Glossiness", leavesSmoothnessPBR);
                }
            }
            
            #if UNITY_EDITOR
            {
                EditorUtility.DisplayProgressBar(textProgressBar == "" ? "Generating Texture Billboard... " : textProgressBar, "Generating Texture Billboard... ", 0.8f);
            }
            #endif
            ...
            else
            {
                #if UNITY_EDITOR
                {
                    ...
                    if (System.IO.File.Exists(Application.dataPath + "/Plugins/AltSystems/AltTrees/DataBase/Trees/TreeResources/" + folderResources + "/Billboard/" + id + ".png"))
                    {
                        ...
                        if (System.IO.File.Exists(Application.dataPath + "/Plugins/AltSystems/AltTrees/DataBase/Trees/TreeResources/" + folderResources + "/Billboard/" + id + ".png.meta"))
                            System.IO.File.Delete(Application.dataPath + "/Plugins/AltSystems/AltTrees/DataBase/Trees/TreeResources/" + folderResources + "/Billboard/" + id + ".png.meta");
                    }
                    ...
                    if (System.IO.File.Exists(Application.dataPath + "/Plugins/AltSystems/AltTrees/DataBase/Trees/TreeResources/" + folderResources + "/Billboard/" + id + "_normal.png"))
                    {
                        ...
                        if (System.IO.File.Exists(Application.dataPath + "/Plugins/AltSystems/AltTrees/DataBase/Trees/TreeResources/" + folderResources + "/Billboard/" + id + "_normal.png.meta"))
                            System.IO.File.Delete(Application.dataPath + "/Plugins/AltSystems/AltTrees/DataBase/Trees/TreeResources/" + folderResources + "/Billboard/" + id + "_normal.png.meta");
                    }
                    ...
                    if (System.IO.File.Exists(Application.dataPath + "/Plugins/AltSystems/AltTrees/DataBase/Trees/TreeResources/" + folderResources + "/Billboard/" + id + ".mat"))
                    {
                        ...
                        if (System.IO.File.Exists(Application.dataPath + "/Plugins/AltSystems/AltTrees/DataBase/Trees/TreeResources/" + folderResources + "/Billboard/" + id + ".mat.meta"))
                            System.IO.File.Delete(Application.dataPath + "/Plugins/AltSystems/AltTrees/DataBase/Trees/TreeResources/" + folderResources + "/Billboard/" + id + ".mat.meta");
                    }
                    ...
                    materialBillboard.SetColor("_SpecularColor", leavesSpecularPBR);
                    materialBillboard.SetFloat("_Glossiness", leavesSmoothnessPBR);
                    ...
                    materialBillboardGroup.SetColor("_SpecularColor", leavesSpecularPBR);
                    materialBillboardGroup.SetFloat("_Glossiness", leavesSmoothnessPBR);
                    ...
                    normalMapBillboard = (Texture2D)AssetDatabase.LoadAssetAtPath("Assets/Plugins/AltSystems/AltTrees/DataBase/Trees/TreeResources/" + folderResources + "/Billboard/" + id + "_normal.png", typeof(Texture2D));
            ...
            RenderSettings.reflectionIntensity = reflectionIntensityStar;
        ...
        public void setSettings(Color _hueVariationLeaves, Color _hueVariationBark, Color _color, bool _isMeshCrossFade, bool _isBillboardCrossFade, bool _isObject, bool _drawPlaneBillboard, bool forceUpdateTexture = false)
        {
            ...
            if (barkMaterials != null)
            {
                ...
                {
                    barkMaterials[i].SetColor("_Color", _color);
            ...
            if (leavesMaterials != null)
            {
                ...
                {
                    leavesMaterials[i].SetColor("_Color", _color);
                    leavesMaterials[i].SetColor("_HueVariation", hueVariationLeaves);
                }
            }

            if (!color.Equals(_color) || forceUpdateTexture)
            {
                color = _color;
        ...
        public bool checkVersionTree(bool updateAltTrees = false, string textProgressBar = "", bool saveObj = true)
        {
            #if UNITY_EDITOR
            {
                if(version < 2)
                {
                    billboardsMipMapBias = -2f;
                    billboardsNormalMapMipMapBias = -1.4f;
                    filterMode = FilterMode.Bilinear;
                    mipmapEnabled = true;
                    anisoLevel = 8;
                    filterMode_Normals = FilterMode.Bilinear;
                    mipmapEnabled_Normals = true;
                    anisoLevel_Normals = 8;
                    
                    getTextureBillboard(false, textProgressBar);

                    version = 5;
                    if (isObject && lods[0].GetComponent<MeshFilter>().sharedMesh.triangles.Length < 500)
                        gpuInstancing = true;
                    else
                        gpuInstancing = false;
