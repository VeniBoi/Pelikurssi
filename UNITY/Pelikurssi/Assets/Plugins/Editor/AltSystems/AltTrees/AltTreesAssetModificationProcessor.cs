                        ...
                        if (delete)
                        {
                            if (!isFolder)
                            {
                                if (!tree.folderResources.Equals("") && Directory.Exists("Assets/Plugins/AltSystems/AltTrees/DataBase/Trees/TreeResources/" + tree.folderResources))
                                {
                                    ...
                                    if (File.Exists("Assets/Plugins/AltSystems/AltTrees/DataBase/Trees/TreeResources/" + tree.folderResources + ".meta"))
                                        File.Delete("Assets/Plugins/AltSystems/AltTrees/DataBase/Trees/TreeResources/" + tree.folderResources + ".meta");
                                }
                            }
                        }
